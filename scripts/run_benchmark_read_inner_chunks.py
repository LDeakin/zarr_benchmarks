...
implementation_to_args = {
    "zarrs_rust": ["zarrs_benchmark_read_sync", "--inner-chunks", "--concurrent-chunks"],
    "zarrs_rust_async_as_sync": ["zarrs_benchmark_read_async_as_sync", "--inner-chunks", "--concurrent-chunks"],
    "zarrs_rust_async": ["zarrs_benchmark_read_async", "--inner-chunks", "--concurrent-chunks"],
    "tensorstore_python": ["./scripts/tensorstore_python_benchmark_read.py", "--inner_chunks", "--concurrent_chunks"],
    "zarr_python": ["./scripts/zarr_python_benchmark_read.py", "--inner_chunks", "--concurrent_chunks"],
    # "zarr_dask_python": ["./scripts/zarr_dask_python_benchmark_read.py", "--concurrent_chunks"],
    "zarrs_python": ["./scripts/zarrs_python_benchmark_read.py", "--inner_chunks", "--concurrent_chunks"],
...
implementations = [
    ...
    "zarrs_rust_async",
    "tensorstore_python",
    # "zarr_python", # Too slow
    # "zarrs_python", # Too slow
    # "zarr_dask_python",
    # "zarrs_dask_python",
]
...
df_markdown.to_markdown("measurements/benchmark_read_inner_chunks.md", floatfmt=".02f")
